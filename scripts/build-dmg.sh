#!/usr/bin/env bash
#
# Build mixr-<version>.dmg — a drag-to-install disk image containing
# mixr.app + a symlinked /Applications shortcut.
#
#   ./scripts/build-dmg.sh         # debug profile
#   ./scripts/build-dmg.sh release # release profile (what ships)
#
# Output: target/mixr-<version>.dmg.
#
...
DMG="target/mixr-${VERSION}.dmg"
VOLNAME="mixr ${VERSION}"
